...
@section('heading','Editare Filtru Nivel De Experienta ')
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_experienta_job_modifica',$experienta_job->id) }}" method="post" >
                        @csrf
                        <div class="form-group mb-3">
                            <label>Nivel Experienta</label>
                            <input type="text" class="form-control" name="nume_experienta" value="{{ $experienta_job->nume_experienta }}">
                        </div>
