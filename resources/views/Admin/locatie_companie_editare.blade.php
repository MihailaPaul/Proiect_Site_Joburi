...
@section('heading','Editare Locatie companie')
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_locatie_companie_modifica',$locatie_companie->id) }}" method="post" >
                        @csrf
                        <div class="form-group mb-3">
                            <label>Nume Locatie</label>
                            <input type="text" class="form-control" name="nume_locatie" value="{{ $locatie_companie->nume_locatie }}">
                        </div>
