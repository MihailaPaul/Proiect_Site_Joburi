...
@section('heading','Creare Domeniu Companie')
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action={{ route('admin_domeniu_companie_salveaza') }} method="post" >
                        @csrf
                        <div class="form-group mb-3">
                            <label>Nume Experienta</label>
                            <input type="text" class="form-control" name="nume_domeniu" value="">
                        </div>
