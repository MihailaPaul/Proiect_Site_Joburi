...
@section('heading','Creare Interval Marime Companie')
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action={{ route('admin_marime_companie_salveaza') }} method="post" >
                        @csrf
                        <div class="form-group mb-3">
                            <label>Interval Marime</label>
                            <input type="text" class="form-control" name="numar_angajati" value="">
                        </div>
