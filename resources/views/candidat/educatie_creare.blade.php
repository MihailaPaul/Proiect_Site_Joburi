...
<div class="page-top"style="background-image: url('{{ asset('uploads/banner.jpg')}}')">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Adauga Educatie/Certificare</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <form action="{{ route('educatie_candidat_salvare') }}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="institutie" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="">Domeniu</label>
                            <div class="form-group">
                                <input type="text" name="domeniu" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="">An Finalizare(In cazul studentilor se mentioneaza anul in care urmeaza sa finalizeze)</label>
                            <div class="form-group">
                                <input type="text" name="data_terminare" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
